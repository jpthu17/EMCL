...
class Trainer(BaseTrainer):
  ...
  def _train_epoch(self, epoch):
    ...
    if self.config.get("labels2", default=False) or self.config.get("em", default=False):
        out = "embds"
    i = 0
  ...
  def _get_embeddings(self, val_loader):
    ...
    with torch.no_grad():
      ...
      for batch_idx, minibatch in enumerate(val_loader):
        ...
        _query_masks = torch.from_numpy(minibatch["query_masks"])
        ...
        query_masks_list.append(_query_masks)
